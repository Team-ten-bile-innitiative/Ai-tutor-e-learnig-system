...
async function seed() {
  ...
  const catalogExtras = [
    ...
    },
    {
      ...
      level: "beginner" as const,
      duration: "5 weeks",
      instructorName: "Abdirahman Mohamed",
    ...
    },
    {
      ...
      description: "Query real datasets, join tables, and turn raw rows into clear business answers.",
      category: "Data Science",
      level: "beginner" as const,
      duration: "5 weeks",
      instructorName: "Nadia Hassan",
      learningObjectives: ["Write SELECT queries", "Join related tables", "Summarize data with aggregates"],
    },
    {
      title: "UI/UX Design Fundamentals",
      description: "Learn research, wireframes, and visual design so your products feel simple and useful.",
      category: "Design",
      level: "beginner" as const,
      duration: "6 weeks",
      instructorName: "Fatima Ali",
      learningObjectives: ["Run quick user research", "Create wireframes", "Build a polished mockup"],
    },
    {
      title: "Intro to Artificial Intelligence",
      description: "Understand AI concepts, everyday tools, and how to use them safely in learning and work.",
      category: "AI & ML",
      level: "beginner" as const,
      duration: "5 weeks",
      instructorName: "Abdirahman Mohamed",
      learningObjectives: ["Explain common AI terms", "Choose the right AI tool", "Spot bias and limitations"],
    },
    {
      title: "Marketing Strategy",
      description: "Plan campaigns, know your audience, and measure what actually drives growth.",
      category: "Business",
      level: "intermediate" as const,
      duration: "6 weeks",
      instructorName: "Sara Malik",
      learningObjectives: ["Define a target audience", "Build a simple campaign plan", "Track key marketing metrics"],
    },
    {
      title: "Business Communications",
      description: "Write emails, present ideas, and collaborate clearly in professional settings.",
      category: "Business",
      level: "beginner" as const,
      duration: "4 weeks",
      instructorName: "Hassan Hussein",
      learningObjectives: ["Write clear professional emails", "Structure short presentations", "Give useful feedback"],
    },
    {
      title: "Biology Foundations",
      description: "Explore cells, genetics, and life systems with clear examples and practice quizzes.",
      category: "Science",
      level: "beginner" as const,
      duration: "7 weeks",
      instructorName: "Amina Yusuf",
      learningObjectives: ["Describe cell structure", "Explain basic genetics", "Connect systems in the body"],
    },
  ];
